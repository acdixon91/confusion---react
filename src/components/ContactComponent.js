        ...
        <div className="row row-content">
          ...
          <div className="col-12 col-md-9">
            <Form onSubmit={this.handleSubmit}>
              <FormGroup row>
                <Label className="font-weight-bold" htmlFor="firstname" md={2}>
                  First Name
                </Label>
                <Col md={10}>
                  <Input
              ...
              <FormGroup row>
                <Label className="font-weight-bold" htmlFor="lastname" md={2}>
                  Last Name
                </Label>
                <Col md={10}>
                  <Input
              ...
              <FormGroup row>
                <Label className="font-weight-bold" htmlFor="telnum" md={2}>
                  Contact Tel.
                </Label>
                <Col md={10}>
                  <Input
              ...
              <FormGroup row>
                <Label className="font-weight-bold" htmlFor="email" md={2}>
                  Email
                </Label>
                <Col md={10}>
                  <Input
              ...
              <FormGroup row>
                <Label className="font-weight-bold" htmlFor="message" md={2}>
                  Your Feedback
                </Label>
                <Col md={10}>
                  <Input
